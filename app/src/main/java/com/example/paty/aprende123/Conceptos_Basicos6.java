...
public class Conceptos_Basicos6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conceptos__basicos6);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                */
                ...
                iv.setImageDrawable(getDrawable(R.drawable.cb_encima));
            }
        });
    }
    public void conceptos_basicos6(View v) {

    }
    public void conceptos_basicos7(View v) {
        Intent i = new Intent(this, Conceptos_Basicos7.class);
