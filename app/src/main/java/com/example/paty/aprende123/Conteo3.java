...
public class Conteo3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conteo3);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                */
                ...
                iv.setImageDrawable(getDrawable(R.drawable.num3));
            }
        });
    }
    public void conteo3(View v) {

    }
    public void conteo4(View v) {
        Intent i = new Intent(this, Conteo4.class);
