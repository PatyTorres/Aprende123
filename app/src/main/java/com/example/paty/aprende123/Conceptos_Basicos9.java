...
public class Conceptos_Basicos9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conceptos__basicos9);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                */
                ...
                iv.setImageDrawable(getDrawable(R.drawable.cb_dentro));
            }
        });
    }
    ...
    public void conceptos_basicos10(View v) {
        Intent i = new Intent(this, Conceptos_Basicos10.class);
