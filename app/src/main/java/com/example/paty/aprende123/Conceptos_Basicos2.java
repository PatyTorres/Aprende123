...
public class Conceptos_Basicos2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conceptos__basicos2);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                */
                ...
                iv.setImageDrawable(getDrawable(R.drawable.cb_izquierda));
            }
        });
    }
    ...
    public void conceptos_basicos3(View v) {
        Intent i = new Intent(this, Conceptos_Basicos3.class);
