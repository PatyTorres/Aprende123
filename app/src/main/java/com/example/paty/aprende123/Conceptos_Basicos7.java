...
public class Conceptos_Basicos7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conceptos__basicos7);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                */
                ...
                iv.setImageDrawable(getDrawable(R.drawable.cb_debajo));
            }
        });
    }
    ...
    public void conceptos_basicos8(View v) {
        Intent i = new Intent(this, Conceptos_Basicos8.class);
